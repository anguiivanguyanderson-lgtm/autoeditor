...
export async function renderWebCodecs(spec, imagesByName, onProgress, shouldCancel, logs = []) {
  ...
  log(`video ${W}x${H} @ ${fps}fps, ${total.toFixed(1)}s, ${totalFrames} frames, codec ${codec}, bitrate 8 Mbps`);
